                ...
                <div className='w-full flex items-center h-full bg-white justify-center'>
                    <div className='flex flex-col items-center'>
                        <div className='flex flex-col items-center justify-center gap-4'>
                            ...
                            <h1 className='text-[#111] text-[28px] font-semibold'>Login your account</h1>
                            ...
                            <div className='w-full'>
                                <form onSubmit={handleSubmit} className="space-y-4" autoComplete='off' autoFocus={false}>
                                    ...
                                    <p className='text-sm text-gray-500'>Don't have account? <Link href={'/sign-up'} className='text-blue-700'>Sign up</Link></p>
